...
module EFTCAMB_pure_EFT_mod
    ...
    type, extends ( EFTCAMB_designer_model ) :: EFTCAMB_mod_pure_EFT
        ...
        integer  :: EFTxDE              !< Model selection flag for Pure EFT w DE.
        ...
        class( parametrized_function_1D ), allocatable :: PureEFTxDE      !< The pure EFT function w_DE.
...
contains
    ...
    subroutine EFTCAMBPureEFTstdAllocateModelSelection( self, Ini )
        ...
        call self%PureEFTxDE%init_func_from_file   ( Ini )
